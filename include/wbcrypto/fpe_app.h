...
#define WBCYRPTO_FPE_CIPHER_WBSM4_SE_LA "wbsm4_se_la"
#define WBCYRPTO_FPE_CIPHER_SM4_LUT "sm4_lut"
#define WBCYRPTO_FPE_CIPHER_WBSM4_XL_LA "wbsm4_xl_la"
#define WBCRYPTO_FPE_CIPHER_SDF_SM4 "sdf_sm4"
